...
- Add a note. This can be anything, but I write something like `PAT-2023-01-23`
...
This is especially relevant for our class, because **I have created tutorials and code for each of the class modules and hosted them in repositories on GitHub:** <https://github.com/MSCI-709>
...
Go to the course GitHub page <https://github.com/MSCI-709> and Fork the first module `unit_1_getting_started` to your own GitHub profile:

-  Go to the course GitHub page <https://github.com/MSCI-709>
